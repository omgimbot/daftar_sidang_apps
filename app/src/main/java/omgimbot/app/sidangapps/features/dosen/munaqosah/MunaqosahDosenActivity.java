...
public class MunaqosahDosenActivity extends AppCompatActivity implements IJudulDosenView,PengajuanAdapter.onSelected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_munaqosah_dosen);
        ButterKnife.bind(this);
        presenter = new PengajuanPresenter(this);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Pengajuan Munaqosah");
    ...
    @Override
    public void refresh() {
        Intent a = new Intent(this, MunaqosahDosenActivity.class);
        startActivity(a);
        finish();
    }
