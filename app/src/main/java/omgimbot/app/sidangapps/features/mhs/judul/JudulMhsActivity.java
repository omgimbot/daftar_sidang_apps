...
public class JudulMhsActivity extends AppCompatActivity implements IJudulMhsView {
    @BindView(R.id.mNama)
    TextView mNama;
    @BindView(R.id.mNim)
    TextView mNim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_judul_mhs);
        ButterKnife.bind(this);
        presenter = new JudulMhsPresenter(this);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Pendaftaran Judul");
