...
public class KompreDosenActivity extends AppCompatActivity implements IJudulDosenView,PengajuanAdapter.onSelected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kompre_dosen);
        ButterKnife.bind(this);
        presenter = new PengajuanPresenter(this);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Pengajuan Kompre");
