...
public class MunaqosahMhsActivity extends AppCompatActivity implements IJudulMhsView {
    @BindView(R.id.mNama)
    TextView mNama;
    @BindView(R.id.mNim)
    TextView mNim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_munaqosah_mhs);
...
//        Toast.makeText(this, String.valueOf(data), Toast.LENGTH_SHORT).show();
        if (data != null) {
            if (!data.getStatus().equals("acc")) {
                SweetDialogs.commonWarningWithIntent(this, "Gagal memuat permintaan", "Anda harus mendapatkan Acc kompre terlebih dahulu", view -> this.goToDashboard());
            } else {
                mJudul.setText(data.getJudul());
                mJudul.setEnabled(false);
            }
        } else {
            SweetDialogs.commonWarningWithIntent(this, "Gagal memuat permintaan", "Anda harus mengajukan kompre terlebih dahulu", view -> this.goToDashboard());
        }
