...
public class JudulDosenActivity extends AppCompatActivity implements IJudulDosenView, PengajuanAdapter.onSelected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_judul_dosen);
        ButterKnife.bind(this);
        presenter = new PengajuanPresenter(this);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Pengajuan Judul");
        ...
        presenter.getListPengajuan("judul", nim);
    ...
    @Override
    public void refresh() {
        Intent a = new Intent(this, JudulDosenActivity.class);
        startActivity(a);
        finish();
    }
