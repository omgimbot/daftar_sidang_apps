...
public class KompreMhsActivity_ViewBinding implements Unbinder {
  private KompreMhsActivity target;
  ...
  @UiThread
  public KompreMhsActivity_ViewBinding(KompreMhsActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public KompreMhsActivity_ViewBinding(final KompreMhsActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    KompreMhsActivity target = this.target;
